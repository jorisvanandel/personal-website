...
const projects: Project[] = [
    ...
    },
    {
        ...
        logo: (
            <svg className="h-10 [&_*]:transition [&_*]:duration-300 [&_*]:ease-out [&_rect]:fill-zinc-200 [&_path]:fill-zinc-400 group-hover:[&_rect]:fill-[#00473B] group-hover:[&_path]:fill-[#A0C34E]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" fill="none">
